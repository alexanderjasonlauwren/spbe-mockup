...
const mockBranches: Branch[] = [
  ...
  },
  {
    ...
    nama: "Cabang Depok",
    kode: "DPK-01",
    alamat: "Jl. Margonda Raya No. 201, Depok",
    kota: "Depok",
  ...
  },
  {
    ...
    nama: "Cabang Bogor",
    kode: "BGR-01",
    alamat: "Jl. Pajajaran No. 78, Bogor",
    kota: "Bogor",
    penanggungJawab: "Siti Nurjanah",
    noHP: "0251-555-0303",
    status: "aktif",
    jumlahDriver: 1,
    jumlahPangkalan: 5,
...
const mockNotifSettings: NotifSetting[] = [
  {
    id: "1",
    kategori: "Kuota SA",
    deskripsi: "Notifikasi ketika sisa kuota SA di bawah 10%",
    email: true,
    push: true,
    sms: false,
  },
  {
    id: "2",
    kategori: "SA Baru",
    deskripsi: "Pengingat untuk mengunduh SA baru dari SPBE",
    email: true,
    push: true,
    sms: true,
  },
  {
    id: "3",
    kategori: "Pembayaran Pending",
    deskripsi:
      "Notifikasi pembayaran yang belum diverifikasi lebih dari 24 jam",
    email: true,
    push: false,
    sms: false,
  },
  {
    id: "4",
    kategori: "Rencana Distribusi",
    deskripsi: "Pengingat membuat rencana distribusi harian (setiap pagi)",
    email: false,
    push: true,
    sms: false,
  },
  {
    id: "5",
    kategori: "Driver Tidak Lapor",
    deskripsi: "Alert ketika driver tidak memperbarui status setelah 2 jam",
    email: false,
    push: true,
    sms: true,
  },
  {
    id: "6",
    kategori: "Laporan Harian",
    deskripsi: "Ringkasan distribusi harian dikirim setiap sore",
    email: true,
    push: false,
    sms: false,
  },
              ...
              <CardContent className="pt-6 space-y-4">
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  <div className="space-y-1.5">
                    ...
                    <Input
                      defaultValue="PT. GasDistrib Nusantara"
                      className="bg-white dark:bg-dark-900 border-gray-300 dark:border-dark-600"
                    />
                  </div>
                  <div className="space-y-1.5">
                    <Label className="text-sm font-medium text-gray-700 dark:text-gray-300">
                      No. SPBE / ID Distributor
                    </Label>
                    <Input
                      defaultValue="SPBE-2024-0001"
                      className="bg-white dark:bg-dark-900 border-gray-300 dark:border-dark-600"
                    />
                  </div>
                </div>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
                  ...
                  <div className="space-y-1.5">
                    ...
                    <Input
                      defaultValue="info@gasdistrib.id"
                      className="bg-white dark:bg-dark-900 border-gray-300 dark:border-dark-600"
                    />
                  </div>
                  <div className="space-y-1.5">
                    ...
                    <Input
                      defaultValue="www.gasdistrib.id"
                      className="bg-white dark:bg-dark-900 border-gray-300 dark:border-dark-600"
                    />
                  </div>
                </div>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  <div className="space-y-1.5">
                    ...
                    <p className="text-xs text-gray-500 dark:text-gray-400">
                      Alert dikirim ketika sisa kuota di bawah nilai ini
                    </p>
                  </div>
                  <div className="space-y-1.5">
                    <Label className="text-sm font-medium text-gray-700 dark:text-gray-300">
                      Batas Waktu Verifikasi Bayar (Jam)
                    </Label>
                    <Input
                      type="number"
                      defaultValue="24"
                    ...
                    />
                    <p className="text-xs text-gray-500 dark:text-gray-400">
                      Alert dikirim jika melewati batas waktu ini
                    </p>
                  </div>
                </div>
              </CardContent>
              ...
              <CardContent className="pt-4">
                <div className="flex flex-col items-center gap-3">
                  ...
                  <Button
                    variant="outline"
                    size="sm"
                    className="text-xs gap-1 border-gray-300 dark:border-dark-600 w-full"
                  >
                    Ganti Logo
                  </Button>
                  <p className="text-xs text-gray-500 dark:text-gray-400 text-center">
                    PNG, JPG (max 2MB). Ukuran optimal: 200×200px
                  </p>
                </div>
              </CardContent>
            </Card>
      ...
      {activeTab === "cabang" && (
        <div className="space-y-4">
          <div className="flex items-center justify-between">
            <div>
              <p className="text-sm font-semibold text-gray-900 dark:text-white">
                {mockBranches.length} cabang terdaftar
              </p>
              <p className="text-xs text-gray-500 dark:text-gray-400">
                {mockBranches.filter((b) => b.status === "aktif").length} aktif
              </p>
            </div>
            <CanAccess permission={PERMISSIONS.SETTINGS_EDIT}>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 xl:grid-cols-3 gap-4">
            {mockBranches.map((branch) => (
              <Card
                key={branch.id}
                className="border border-gray-200 dark:border-dark-700 bg-white dark:bg-dark-800 hover:border-slate-400 dark:hover:border-slate-500 transition-colors"
              >
                <CardContent className="p-5">
                  ...
                  <div className="grid grid-cols-3 gap-2 text-center mb-3">
                    ...
                    <div>
                      <p className="text-sm font-bold text-gray-900 dark:text-white">
                        {branch.jumlahDriver + branch.jumlahPangkalan}
                      </p>
                      <p className="text-xs text-gray-500 dark:text-gray-400">
                        Total
                      </p>
                  ...
                  <div className="flex gap-2">
                    <Button
                      size="sm"
                      variant="outline"
                      className="flex-1 text-xs gap-1 border-gray-300 dark:border-dark-600"
                    >
                    ...
                    <Button
                      size="sm"
                      variant="outline"
                      className="text-xs gap-1 border-red-300 dark:border-red-500/30 text-red-700 dark:text-red-400 hover:bg-red-50"
                    >
          ...
          <Card className="border border-gray-200 dark:border-dark-700 bg-white dark:bg-dark-800">
            <CardHeader className="border-b border-gray-100 dark:border-dark-700">
              ...
              <p className="text-sm text-gray-600 dark:text-gray-400">
                Atur cara menerima pemberitahuan sistem.
              </p>
            </CardHeader>
              ...
              <CardContent className="pt-4 space-y-4">
                <div className="space-y-1.5">
                  ...
                  <Input
                    ...
                    className="font-mono text-sm bg-white dark:bg-dark-900 border-gray-300 dark:border-dark-600"
                  />
                </div>
                <div className="space-y-1.5">
                  <Label className="text-sm font-medium text-gray-700 dark:text-gray-300">
                  ...
                  <Input
                    defaultValue="https://portal.pertamina.com/spbe"
                    className="font-mono text-sm bg-white dark:bg-dark-900 border-gray-300 dark:border-dark-600"
                  />
                </div>
            ...
            <Card className="border border-gray-200 dark:border-dark-700 bg-white dark:bg-dark-800">
              ...
              <CardContent className="pt-4 space-y-3">
                {[
                  ...
                  <div
                    key={idx}
                    className="flex items-center justify-between p-3 rounded-xl border border-gray-200 dark:border-dark-700"
                  >
                    <div>
                      ...
                      <p className="text-xs text-gray-500 dark:text-gray-400">
                        {session.ip} • {session.waktu}
                      </p>
                    </div>
                    {session.current ? (
                      <Badge
                        variant="outline"
                        className="text-xs bg-green-50 text-green-700 border-green-300 dark:bg-green-500/10 dark:text-green-400 dark:border-green-500/30"
                      >
                        Saat Ini
                      </Badge>
                    ) : (
                      <Button
                        size="sm"
                        variant="outline"
                        className="text-xs h-7 border-red-300 dark:border-red-500/30 text-red-600 dark:text-red-400 hover:bg-red-50"
                      >
                        Keluar
                      </Button>
                    )}
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-xs text-red-700 dark:text-red-400 mt-0.5">
                      Hapus semua data dan nonaktifkan akun. Tindakan ini tidak
                      dapat dibatalkan.
                    </p>
                  </div>
                  <Button
                    size="sm"
                    variant="outline"
                    className="shrink-0 border-red-400 text-red-700 dark:text-red-400 hover:bg-red-100 text-xs"
                  >
                    Hapus Akun
                  </Button>
                </div>
